...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        assertThat(Calculator.calculatingDiscount(1000.0,25)).isEqualTo(750);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(-150,0)
        ).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(500.0,-50)
        ).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(750.0,100)
        ).isInstanceOf(ArithmeticException.class);
    }
}